        ...
        <div className="hidden md:flex w-1/3 justify-center">
          <form onSubmit={handleResolve} className="relative w-full">
            <input
              ...
              className="w-full border border-neutral-700 bg-[#383838]/20 border border-[#383838] rounded-full p-3 pl-11 outline-hidden"
              placeholder="Search by Steam ID or nickname..."
            />
            <img
              src="../search.svg"
              className="h-8 w-6 absolute top-2 left-3"
            />
          </form>
