                ...
                <div className="grid grid-cols-1 md:grid-cols-6 gap-5 mb-10">
                    ...
                    <div className="bg-[#383838]/20 border border-[#383838] rounded-xl p-5 flex flex-col items-center md:items-start gap-3">
                        <div className="bg-[#07a4f1]/15 p-2 rounded-md w-fit">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M18.3333 10H15" stroke="#07A4F1" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M4.99996 10H1.66663" stroke="#07A4F1" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M10 4.99996V1.66663" stroke="#07A4F1" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M10 18.3333V15" stroke="#07A4F1" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                        </div>
                    ...
                    <div className="bg-[#383838]/20 border border-[#383838] rounded-xl p-5 flex flex-col items-center md:items-start gap-3">
                        <div className="bg-[#07a4f1]/15 p-2 rounded-md w-fit">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.99996 18.3333C14.6023 18.3333 18.3333 14.6023 18.3333 9.99996C18.3333 5.39759 14.6023 1.66663 9.99996 1.66663C5.39759 1.66663 1.66663 5.39759 1.66663 9.99996C1.66663 14.6023 5.39759 18.3333 9.99996 18.3333Z" stroke="#07A4F1" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M10 15C12.7614 15 15 12.7614 15 10C15 7.23858 12.7614 5 10 5C7.23858 5 5 7.23858 5 10C5 12.7614 7.23858 15 10 15Z" stroke="#07A4F1" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M10 11.6667C10.9205 11.6667 11.6667 10.9205 11.6667 10C11.6667 9.07957 10.9205 8.33337 10 8.33337C9.07957 8.33337 8.33337 9.07957 8.33337 10C8.33337 10.9205 9.07957 11.6667 10 11.6667Z" stroke="#07A4F1" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                        </div>
