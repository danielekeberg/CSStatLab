  ...
  return rows
    ...
    .map((r, idx) => {
      ...
      const aim = calcAimScore({
        ...
        counterStrafeRatio:
          (r as any).counter_strafing_shots_good_ratio ?? null,
      });
      ...
      return {
        ...
        preaim:
          typeof r.preaim === 'number' ? Number(r.preaim.toFixed(2)) : null,
        ttd:
  ...
  return (
    <>
      {filtered.length === 0 ? null : (
        <div className="hidden lg:block w-full rounded-2xl p-4 bg-zinc-900/50 border border-[#383838] rounded-xl p-5">
          <div className="mb-3 flex items-center justify-between gap-3">
            <div>
              <div className="text-sm font-bold text-[#b3c0d3]">
                PERFORMANCE
              </div>
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                />
                <YAxis tickMargin={1} width={50} fontSize={15} />
                <Line
                  type="monotone"
                  dataKey={metric}
                  strokeWidth={2}
