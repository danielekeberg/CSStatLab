      ...
      <div className="md:px-[15%] mt-10 mb-50">
        ...
        <div className="my-5 flex flex-col gap-2">
          ...
          <div className="pl-5">
            <div>
              <p>
                CSStatLab (“we”, “us”, or “our”) provides statistical analysis
                and visual insights based on publicly available gameplay data
                from platforms such as Steam, Leetify, and FACEIT.
              </p>
              <p>
            ...
            <p>
              By accessing CSStatLab, you agree to the terms described in this
              Privacy Policy.
            </p>
          </div>
        </div>
        <div className="my-5 flex flex-col gap-2">
          ...
          <div className="pl-5">
            ...
            <div className="pl-5">
              <p>
                We collect and display <strong>public accessible data</strong>{' '}
                from third-party services, including but not limited to:
              </p>
              <ul className="list-disc pl-10">
                ...
                <li>
                  Derived metrics such as KD, win rate, aim rating, and
                  cheat-risk estimations
                </li>
              </ul>
              <p>
                We <strong>do not</strong> access or store any private date,
                private match history, hidden Steam data, email addresses, or
                passwords
              </p>
            </div>
            ...
            <div className="pl-5">
              <p>
                We may use basic analytics to collect anonymized information
                such as:
              </p>
              <ul className="list-disc pl-10">
                <li>Browser type</li>
          ...
          <div className="pl-5">
            ...
            <ul className="list-disc pl-10">
              ...
              <li>
                Cache recent match data to reduce API load and improve
                performace
              </li>
            </ul>
            <p>
              We <strong>never</strong> sell, rent, or share your personal data
          ...
          <div className="pl-5">
            <p>
              ...
              related to gaming or Counter-Strike.
            </p>
            <p>
              If you click on an affiliate link and sign up or make a purchase,
              we may receive a small commission at no additional cost to you.
            </p>
            <p>
              Affiliate partners may use cookies or similar technologies in
          ...
          <div className="pl-5">
            ...
            <p>
              If a player has no recent matches or their profile is set to
              private, cached data may remain until manually deleted or
          ...
          <div className="pl-5">
            ...
            <p>
              If you believe a minor's information has been processed, contact
