    ...
    <div className="px-5 md:px-[15%]">
      ...
      <div className="md:px-[15%] mt-10 mb-50">
        <h1 className="text-3xl font-bold">
          Terms of Service (ToS) for CSStatLab
        </h1>
        ...
        <div className="my-5 flex flex-col gap-2">
          ...
          <div className="pl-5">
            <p>
              By accessing or using CSStatLab ("the Service"), you agree to be
              bound by these Terms of Service.
            </p>
            <p>If you do not agree, you may not use the Service.</p>
            <p>
              CSStatLab reserves the right to update or change these terms at
              any time. Continued to use the Service constitutes acceptance of
              the updated terms.
            </p>
          </div>
          ...
          <div className="pl-5">
            ...
            <ul className="list-disc pl-10">
              ...
              <li>
                Aggregated metrics such as KD, win rate, aim rating, and more
              </li>
            </ul>
            <p>
              The Service relies on publicly accessible APIs from Steam,
              Leetify, and FACEIT
            </p>
            <p>
              CSSTatLab is <strong>not affiliated</strong> with Valve, Steam,
              FACEIT, or Leetify
            </p>
          </div>
          ...
          <div className="pl-5">
            ...
            <ul className="list-disc pl-10">
              ...
              <li>
                You agree to these <u>Terms</u> and the{' '}
          ...
          <div className="pl-5">
            <p>
              When using CSStatLab, you agree <strong>not</strong> to:
            </p>
            <ul className="list-disc pl-10">
              <li>Attempt to access private or hidden data</li>
              <li>
                Use the site for harassment, doxxing, or targeted abuse of
                players
              </li>
              <li>
                Reverse-engineer, scrape aggressively, or automate excessive
                requests
              </li>
              <li>Exploit vulnerabilities or attempt unauthorized access</li>
              <p>
                Use CSStatLab for cheating, boosting, or competitive
                manipulation
              </p>
            </ul>
            <p>
              Player statistics displayed are{' '}
              <strong>publicly available</strong> data
            </p>
            <p>
              You are responsible for how you choose to use or interpret this
              information
            </p>
          </div>
          <h3 className="text-2xl font-bold">
            5. Data and Accuracy Disclaimer
          </h3>
          <div className="pl-5">
            <p>The Service displays data sourced from third-party APIs</p>
            <p>
              Therefore, we <strong>cannot guarantee</strong>:
            </p>
            <ul className="list-disc pl-10">
              <li>Accuracy</li>
              <li>Completeness</li>
            ...
            <p>
              Match data and player stats may be incomplete, delayed, or
              temporarily unavailable due to limitations of external APIs
            </p>
          ...
          <div className="pl-5">
            <p>
              All content on CSStatLab - including UI, graphics, computed
              metrics, and statistical models - is the property of the Service
            ...
            <p>
              However, you may share screenshots and links for personal or
              community use
            </p>
          </div>
          ...
          <div className="pl-5">
            <p>
              CSStatLab is provided "<strong>as is</strong>" without warranties
              of any kind
            </p>
            <p>
          ...
          <div className="pl-5">
            <p>
              CSStatLab does <strong>not</strong> require user accounts
            </p>
            <p>
              All information displayed is based on public player data retrived
              from:
            </p>
            <ul className="list-disc pl-10">
              <li>Steam Web API</li>
            ...
            <p>
              For details on how we handle data, refer to our{' '}
          ...
          <div className="pl-5">
            <p>
              The Service may link to external websites such as Steam, FACEIT,
              or Leetify
            </p>
            <p>
              We do not control and are not responsible for their content or
              practices
            </p>
          </div>
          ...
          <div className="pl-5">
            <p>
              We reserve the right to restrict or block access to the Service
              for any user who:
            </p>
            <ul className="list-disc pl-10">
          ...
          <div className="pl-5">
            <p>
              These Terms are governed by the laws of <strong>Norway</strong>
            </p>
            <p>
              Any disputes will be handled under Norwegian legal jurisdiction
          ...
          <div className="pl-5">
            ...
            <p>
              <strong>Email:</strong> daneke75160@gmail.com
            </p>
            <p>
              <strong>Website:</strong>{' '}
              <Link className="hover:underline" href="https://csstatlab.com">
                https://csstatlab.com
              </Link>
            </p>
          </div>
